...
from .DepthWiseConvModule import DepthWiseConvModule
from elif_model.models.act_norm.attention import ChannelAttention
...
class CSPNeXtBlock(nn.Module):
    ...
    def __init__(self,
        ...
        self.conv2 = nn.Sequential(self.depthwise_conv, self.pointwise_conv)
        """
...
class CSPLayer(nn.Module):
    ...
    def __init__(self,
                 ...
                 norm_cfg: dict = dict( momentum=0.03, eps=0.001),
