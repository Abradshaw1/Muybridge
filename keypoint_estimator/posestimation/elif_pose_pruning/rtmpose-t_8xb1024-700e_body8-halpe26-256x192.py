...
dataset_coco = dict(
    ...
    data_root=data_root,
    data_mode=data_mode,
    ann_file='/datasets/basokure/COCO/annotations/coco_wholebody_train_v1.0.json',
    data_prefix=dict(img='/datasets/basokure/COCO/train2017/'),
    pipeline=[
        dict(
...
dataset_halpe = dict(
    ...
    data_root=data_root,
    data_mode=data_mode,
    ann_file='/datasets/basokure/Halpe/annotations/halpe_train_v1.json',
    data_prefix=dict(img='/datasets/basokure/Halpe/hico_20160224_det/images/train2015'),
    pipeline=[
        dict(
            type='KeypointConverter',
            num_keypoints=num_keypoints,
...
val_coco = dict(
    ...
    data_root=data_root,
    data_mode=data_mode,
    ann_file='/datasets/basokure/COCO/annotations/coco_wholebody_val_v1.0.json',
    data_prefix=dict(img='/datasets/basokure/COCO/val2017/'),
    pipeline=[
        dict(
            type='KeypointConverter',
            num_keypoints=num_keypoints,
...
val_halpe = dict(
    ...
    data_root=data_root,
    data_mode=data_mode,
    ann_file='/datasets/basokure/Halpe/annotations/halpe_val_v1.json',
    data_prefix=dict(img='/datasets/basokure/COCO/val2017/'),
    pipeline=[
        dict(
            type='KeypointConverter',
