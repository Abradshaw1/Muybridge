...
algorithm = dict(
    ...
    init_cfg=dict(checkpoint='./work_dir/flops_0.51.pth', type='Pretrained'),
    interval=10,
    mutator=dict(
        channel_unit_cfg=dict(
            default_args=dict(normalization_type='act'),
            type='GroupFisherChannelUnit'),
        parse_cfg=dict(tracer_type='FxTracer', type='ChannelAnalyzer'),
...
dataset_coco = dict(
    ann_file=
    '/datasets/basokure/COCO/annotations/coco_wholebody_train_v1.0.json',
    data_mode='topdown',
...
dataset_halpe = dict(
    ...
    data_mode='topdown',
    data_prefix=dict(
        img='/datasets/basokure/Halpe/hico_20160224_det/images/train2015'),
    data_root='',
    pipeline=[
        dict(
            mapping=[
...
model = dict(
    ...
    algorithm=dict(
        ...
        architecture=dict(
            ...
            type='TopdownPoseEstimator'),
        init_cfg=dict(
            checkpoint='./work_dir/flops_0.51.pth', type='Pretrained'),
        interval=10,
        mutator=dict(
            channel_unit_cfg=dict(
                default_args=dict(normalization_type='act'),
...
pretrained_path = './rtmpose-t_simcc-body7_pt-body7-halpe26_700e-256x192-6020f8a6_20230605.pth'
pruned_path = './work_dir/flops_0.51.pth'
...
test_dataloader = dict(
    ...
    dataset=dict(
        datasets=[
            dict(
                ann_file=
                '/datasets/basokure/COCO/annotations/coco_wholebody_val_v1.0.json',
                data_mode='topdown',
...
train_dataloader = dict(
    ...
    dataset=dict(
        datasets=[
            ...
            dict(
                ann_file=
                '/datasets/basokure/Halpe/annotations/halpe_train_v1.json',
                data_mode='topdown',
                data_prefix=dict(
                    img=
                    '/datasets/basokure/Halpe/hico_20160224_det/images/train2015'
                ),
                data_root='',
                pipeline=[
                    dict(
